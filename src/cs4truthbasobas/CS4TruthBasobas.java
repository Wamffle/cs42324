...
public class CS4TruthBasobas {
    ...
    public static void main(String[] args) {
        ...
        boolean sameHobbies = hob1!=hob2 && hob1!=hob3 && hob2!=hob3;
        System.out.println("The Basobas siblings have distinct hobbies: " + sameHobbies); //(operation: comparison and logical)
        boolean sameSnackPref = snackPref2 == snackPref3;
